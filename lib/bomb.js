var bomb = {
     ...
     * @returns {Number}
     */
    hasBOM: function (str) { // @todo: should probably be renamed to indexOfBOM or something similar
    ...
    trim: function (str) {
        ...
        return typeof str === 'string' && typeof str.slice === 'function' && str.slice(pos) || str;
    }
};
